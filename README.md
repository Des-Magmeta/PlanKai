...
然而，还有大量的扩展区汉字无法被直接显示，或是显示的文本回退到宋体，或是显示为不符合在地标准字形，更多的则显示为「豆腐块」。  
计划楷（Plan Kai）是基于 Klee One 进行字符扩展及补充的项目。该项目由本人在 2022 年 12 月份所开启，最终目标是尽可能补全 Unicode 所有汉字，并制作出一部分原本没有楷体风格的楷体字。
